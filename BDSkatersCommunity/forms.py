...
class SignUpForm(FlaskForm):
    ...
    UserType= SelectField("", validators=[InputRequired()], choices=[("member","member"),("guest","guest"),("seller","seller"),("buyer","buyer"),("admin","admin")])
...
class EventForm(FlaskForm):
    EventName = StringField("",validators=[InputRequired(), Length(min=4, max=30)], render_kw={"placeholder": "Post title"})
    EmailAddress = EmailField("",validators=[InputRequired(), Email()], render_kw={"placeholder": "Email Address"})
    Eventpost = StringField("",validators=[InputRequired(), Length(min=4, max=3000)], render_kw={"placeholder": "Post write"})
